...
document.addEventListener("DOMContentLoaded", function () {
  const services = [
    ...
    },
    {
      ...
      description:
        "Create optimized queries and data models for efficient analysis",
    },
    {
      icon: "bx bx-code-alt",
      title: "Python Analytics",
      description:
        "Implement data processing workflows using Python and pandas",
    },
    {
      icon: "bx bx-bar-chart-alt-2",
      title: "Statistical Analysis",
      description:
        "Apply statistical methods to uncover meaningful patterns in data",
    },
    {
